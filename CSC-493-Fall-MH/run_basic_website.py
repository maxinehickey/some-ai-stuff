# secondary script for only opening website without any AI/chatbot functionality

from package_manager import install_nec_packages, required_packages
install_nec_packages(required_packages[:1])
...
# initialize database for storing user input/output
...
def home():  
    ...
    if request.method == "POST":
        ...
        # if tts_on:
        #     # get tts generation and save audio file for later access
